...
const int modalRightFlex = 3;

const int modalFieldsFlex = 4;

const double edgeWidth = 3.0;

const double paddingAmount = 10.0;

const double smallPaddingAmount = 5.0;

const double cardPaddingAmount = 15.0;

const double modalHeaderHeight = 110.0;
...
const Size elementCardSize = Size(120.0, 80.0);
